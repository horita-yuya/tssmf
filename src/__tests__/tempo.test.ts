...
import { buildTempoMap, ticksToMs, type MidiFile, type TempoPoint } from '../midi';
  ...
  describe('buildTempoMap', () => {
    it('should handle Format 0 files with tempo in single track', () => {
      const midi: MidiFile = {
        ...
        tracks: [{
          events: [
            { delta: 0, type: 'meta', metaType: 0x51, data: new Uint8Array([0x06, 0x1A, 0x80]), tempoUsPerQuarter: 400000 },
            { delta: 480, type: 'channel', subtype: 'noteOn', channel: 0, note: 60, velocity: 80 },
            { delta: 480, type: 'meta', metaType: 0x51, data: new Uint8Array([0x07, 0xA1, 0x20]), tempoUsPerQuarter: 500000 },
        ...
        tracks: [
          {
            // Track 0: Tempo track
            events: [
              { delta: 0, type: 'meta', metaType: 0x51, data: new Uint8Array(), tempoUsPerQuarter: 600000 }, // 100 BPM
              { delta: 1920, type: 'meta', metaType: 0x51, data: new Uint8Array(), tempoUsPerQuarter: 300000 }, // 200 BPM
              { delta: 0, type: 'meta', metaType: 0x2F, data: new Uint8Array(), endOfTrack: true }
            ]
          },
          {
            ...
            events: [
              { delta: 960, type: 'meta', metaType: 0x51, data: new Uint8Array(), tempoUsPerQuarter: 400000 }, // 150 BPM
              { delta: 480, type: 'channel', subtype: 'noteOn', channel: 0, note: 60, velocity: 80 },
              { delta: 960, type: 'meta', metaType: 0x51, data: new Uint8Array(), tempoUsPerQuarter: 250000 }, // 240 BPM
              { delta: 0, type: 'meta', metaType: 0x2F, data: new Uint8Array(), endOfTrack: true }
            ]
          }
        ],
    ...
    it('should handle overlapping tempo changes at same tick', () => {
      const midi: MidiFile = {
        ...
        tracks: [
          ...
          {
            events: [
              { delta: 480, type: 'meta', metaType: 0x51, data: new Uint8Array(), tempoUsPerQuarter: 450000 }, // Same tick, different tempo
              { delta: 0, type: 'meta', metaType: 0x2F, data: new Uint8Array(), endOfTrack: true }
            ]
          }
        ],
    ...
    it('should maintain sorted order when tracks have different tempo timings', () => {
      const midi: MidiFile = {
        ...
        tracks: [
          {
            events: [
              { delta: 1000, type: 'meta', metaType: 0x51, data: new Uint8Array(), tempoUsPerQuarter: 400000 },
              { delta: 2000, type: 'meta', metaType: 0x51, data: new Uint8Array(), tempoUsPerQuarter: 300000 },
              { delta: 0, type: 'meta', metaType: 0x2F, data: new Uint8Array(), endOfTrack: true }
            ]
          },
          {
            events: [
              { delta: 500, type: 'meta', metaType: 0x51, data: new Uint8Array(), tempoUsPerQuarter: 450000 },
              { delta: 1500, type: 'meta', metaType: 0x51, data: new Uint8Array(), tempoUsPerQuarter: 350000 },
              { delta: 0, type: 'meta', metaType: 0x2F, data: new Uint8Array(), endOfTrack: true }
            ]
          }
        ],
    ...
    it('should ignore non-tempo meta events', () => {
      const midi: MidiFile = {
        ...
        tracks: [{
          events: [
            { delta: 0, type: 'meta', metaType: 0x03, data: new Uint8Array(), text: 'Track Name' },
            { delta: 480, type: 'meta', metaType: 0x51, data: new Uint8Array(), tempoUsPerQuarter: 400000 },
            { delta: 0, type: 'meta', metaType: 0x58, data: new Uint8Array(), timeSig: { num: 4, den: 4, metronome: 24, thirtyseconds: 8 } },
            { delta: 480, type: 'meta', metaType: 0x51, data: new Uint8Array(), tempoUsPerQuarter: 350000 },
            { delta: 0, type: 'meta', metaType: 0x2F, data: new Uint8Array(), endOfTrack: true }
          ]
        }],
        ticksPerQuarter: 480
    ...
    it('should handle empty tracks', () => {
      const midi: MidiFile = {
        ...
        tracks: [
          { events: [] },
          { events: [{ delta: 0, type: 'meta', metaType: 0x2F, data: new Uint8Array(), endOfTrack: true }] },
          { events: [] }
        ],
        ticksPerQuarter: 480
      };
    ...
    it('should work correctly with real-world tempo changes', () => {
      ...
      const midi: MidiFile = {
        ...
        tracks: [{
          events: [
            // Start at 60 BPM
            { delta: 0, type: 'meta', metaType: 0x51, data: new Uint8Array(), tempoUsPerQuarter: 1000000 },
            // Speed up to 120 BPM after 4 quarters
            { delta: 1920, type: 'meta', metaType: 0x51, data: new Uint8Array(), tempoUsPerQuarter: 500000 },
            // Speed up to 180 BPM after 4 more quarters
            { delta: 1920, type: 'meta', metaType: 0x51, data: new Uint8Array(), tempoUsPerQuarter: 333333 },
            // Slow down to 90 BPM after 2 quarters
            { delta: 960, type: 'meta', metaType: 0x51, data: new Uint8Array(), tempoUsPerQuarter: 666666 },
            { delta: 0, type: 'meta', metaType: 0x2F, data: new Uint8Array(), endOfTrack: true }
          ]
        }],
        ticksPerQuarter: 480
